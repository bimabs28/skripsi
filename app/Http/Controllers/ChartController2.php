...
class ChartController2 extends Controller
{
    ...
    public function index()
    {
        ...
        return view('chart2', ['data' => $data, 'labels' => $labels, 'ph_data' => $ph_data,'data2' => $data2,'labels2' => $labels2, 'electrical_conductivity' => $electrical_conductivity, 'data3' => $data3, 'labels3' => $labels3, 'humidity' => $humidity, 'data4' => $data4, 'labels4' => $labels4, 'lux' => $lux]);
    }
