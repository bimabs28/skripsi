      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img rsc="{{ asset("/assets/dist/img/user1-128x128.jpg") }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ url("/humidity") }}" class="nav-link {{ (app('request')->route()->uri() == "humidity") ? "active" : ""}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Humidity</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url("/electrical_conductivity") }}" class="nav-link {{ (app('request')->route()->uri() == "electrical_conductivity") ? "active" : ""}}">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="{{ url("/mahasiswa") }}" class="nav-link {{ (app('request')->route()->uri() == "mahasiswa") ? "active" : ""}}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Mahasiswa</p>
                </a>
              </li>
